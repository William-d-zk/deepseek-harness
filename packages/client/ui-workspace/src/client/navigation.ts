 ...
 * @returns the caller's namespace, or undefined when isolation is off.
 */
 ...
 * @param path - workspace working directory.
 * @param namespace - namespace segment the deployment isolates on.
 * @returns true when the namespace is a whole path segment of `path`.
 */
