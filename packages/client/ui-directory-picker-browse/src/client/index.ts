  ...
  ctx.effect(() => {
    ...
    const dictionaries: [locale: string, dict: Record<string, string>][] = [
      ['zh', {
        ...
        'browser.newApp': '新建应用',
        'browser.appName': '应用名称',
        'browser.createAppIn': '在"{name}"中新建应用',
        'browser.untitledApp': '未命名应用',
        'browser.create': '创建',
        'browser.cancel': '取消',
        'browser.open': '打开',
      ...
      ['en', {
        ...
        'browser.newApp': 'New app',
        'browser.appName': 'App name',
        'browser.createAppIn': 'New app in "{name}"',
        'browser.untitledApp': 'Untitled app',
