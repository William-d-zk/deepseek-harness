...
/** Device controls and resource observations one installed audio fixture exposes. */
export interface AudioCaptureFixture {
  readonly recording: Recording
  readonly trackStop: Mock
  readonly close: Mock
...
export function captureFixture(
  options: { empty?: boolean; recorderError?: boolean; constructError?: boolean } = {},
): AudioCaptureFixture {
